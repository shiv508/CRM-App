        ...
        <>
            <div className="my-4 flex flex-col md:flex-row items-center justify-between">
                <div className='flex md:flex-row mb-4'>
                    ...
                    <TextField label="Filter by Activity" variant="outlined" onChange={(e) => dispatch(setTodoFilter(e.target.value))} className='!m-4' />
                </div>
            ...
            <Modal open={isOpen} onClose={() => setIsOpen(false)} className='flex justify-center'>
                <div className="p-4 m-auto w-2/3 md:w-1/3 bg-white rounded-md shadow-md">
                    <PageTitle text='Add New Activities' />
                    {!isAdded && (
                        <>
                    ...
                    {isAdded && (
                        <>
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                />
                                <LabelMessage text='New activity was added successfully. Want to add another to Activities?' />
                            </div>
                        </>
                    )

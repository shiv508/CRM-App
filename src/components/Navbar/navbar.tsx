...
const pages = ['Customers', 'Activities'];
  ...
  return (
    <AppBar position="sticky" color='default' style={{boxShadow: 'none', background: '#f4f3f1'}}>
      <Container maxWidth="xl" className='py-2'>
        ...
        <div className="w-48 mt-1 mx-auto flex justify-center mr-8" onClick={() => setActiveItem && setActiveItem('Welcome To ITM Gwalior CRM Dashboard')}>
        </div>
